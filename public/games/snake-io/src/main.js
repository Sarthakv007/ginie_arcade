 ...
 * Combines features from multiple snake games
 */
...
function initGame() {
    ...
    function create() {
        ...
        // Create player snake with custom name
    ...
    function update() {
        ...
        // Update leaderboard
        updateLeaderboard(this.game.snakes);
        
        // Update minimap
        updateMinimap(this.game, this.minimapCtx);
    ...
    this.snakeDestroyed = function(snake) {
...
// Update minimap UI
function updateMinimap(game, ctx) {
